...
urlpatterns = [
    ...
    path('create/', views.CourseCreateView.as_view(), name = 'course_created'),
    ...
    path('module/<int:module_id>/content/<model_name>/<id>/', views.ContentCreateUpdateView.as_view(), name = 'model_content_update'),
